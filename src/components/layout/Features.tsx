...
export const Features: React.FC = () => {
  ...
  return (
    <section className="bg-white flex w-full flex-col overflow-hidden items-stretch justify-center px-16 py-[146px] max-md:max-w-full max-md:px-5 max-md:py-[100px]">
      <div className="flex mb-[-29px] items-center gap-[40px_41px] flex-wrap max-md:mb-2.5">
        ...
        <div className="self-stretch min-w-60 w-[748px] my-auto rounded-[0px_0px_0px_0px] max-md:max-w-full">
          <div className="flex flex-col relative min-h-[540px] w-full pt-[78px] pb-2 px-[75px] max-md:max-w-full max-md:px-5">
            <img
              src="https://cdn.builder.io/api/v1/image/assets/TEMP/971c1161f256c19ca670ab10fa02de4cf6354fbe?placeholderIfAbsent=true"
              ...
              <div className="email-thread space-y-5 p-3">
                ...
                <div className="email-message">
                  <div className="flex gap-3">
                    <img
                      src="https://cdn.builder.io/api/v1/image/assets/TEMP/bae9a8057a703e2c317f99f8c0f20a99e3472a8f?placeholderIfAbsent=true"
                      alt="ElonAI avatar"
                ...
                <div className="email-message">
                  <div className="flex gap-3">
                    <img
                      src="https://cdn.builder.io/api/v1/image/assets/TEMP/4dc6dc42f6eeffdcd4bccd216f06ee51776b06ea?placeholderIfAbsent=true"
                      alt="Abhijit avatar"
                      className="w-8 h-8 rounded-full"
                    />
                    <div>
